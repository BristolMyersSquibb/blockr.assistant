...
- Application-level persistence wiring. The extension's constructor
  and `state` shape make the system prompt round-trip through
  ...
  is out of the initial roadmap. The chat history was originally part
  of that state and no longer is -- see the superseded wire-format
  section in Phase 1.
